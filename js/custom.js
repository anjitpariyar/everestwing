jQuery(document).ready(function () {
  ...
  $(window).on("scroll", function () {
    if (
      $(window).scrollTop() > $(".top-header").offset().top &&
      !$(".main-menu").hasClass("sticky-header")
    ) {
  ...
  $(".autoplay").slick({
    ...
    autoplaySpeed: 4000,
    prevArrow:
      '<span data-role="none" class="slick-prev" tabindex="0"><i class="fas fa-angle-left" aria-hidden="true"></i></span>',
    nextArrow:
      '<span data-role="none" class="slick-next" tabindex="0"><i class="fas fa-angle-right" aria-hidden="true"></i></span>',
    responsive: [
      {
        breakpoint: 768,
        settings: {
